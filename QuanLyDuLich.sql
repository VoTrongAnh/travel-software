...
/****** Object:  Database [QuanLyDuLich]    Script Date: 20/11/2024 12:43:31 CH ******/
CREATE DATABASE [QuanLyDuLich]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'QuanLyDuLich', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQL2022\MSSQL\DATA\QuanLyDuLich.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'QuanLyDuLich_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQL2022\MSSQL\DATA\QuanLyDuLich_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
